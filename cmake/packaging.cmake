...
if (NOT IRODS_BUILD_AGAINST_LIBCXX)
  set(CPACK_DEBIAN_${IRODS_PACKAGE_COMPONENT_RUNTIME_NAME_UPPERCASE}_PACKAGE_DEPENDS "${CPACK_DEBIAN_${IRODS_PACKAGE_COMPONENT_RUNTIME_NAME_UPPERCASE}_PACKAGE_DEPENDS}, libzmq5")
endif()
...
if (IRODS_LINUX_DISTRIBUTION_NAME STREQUAL "opensuse")
  ...
  if (NOT IRODS_BUILD_AGAINST_LIBCXX)
    set(CPACK_RPM_${IRODS_PACKAGE_COMPONENT_RUNTIME_NAME}_PACKAGE_REQUIRES "${CPACK_RPM_${IRODS_PACKAGE_COMPONENT_RUNTIME_NAME}_PACKAGE_REQUIRES}, libzmq5")
  endif()
else()
  ...
  if (NOT IRODS_BUILD_AGAINST_LIBCXX)
    set(CPACK_RPM_${IRODS_PACKAGE_COMPONENT_RUNTIME_NAME}_PACKAGE_REQUIRES "${CPACK_RPM_${IRODS_PACKAGE_COMPONENT_RUNTIME_NAME}_PACKAGE_REQUIRES}, zeromq")
  endif()
endif()
...
if (NOT IRODS_BUILD_AGAINST_LIBCXX)
  set(CPACK_DEBIAN_${IRODS_PACKAGE_COMPONENT_DEVELOPMENT_NAME_UPPERCASE}_PACKAGE_DEPENDS "${CPACK_DEBIAN_${IRODS_PACKAGE_COMPONENT_DEVELOPMENT_NAME_UPPERCASE}_PACKAGE_DEPENDS}, libzmq3-dev")
endif()
...
if (NOT IRODS_BUILD_AGAINST_LIBCXX)
  set(CPACK_RPM_${IRODS_PACKAGE_COMPONENT_DEVELOPMENT_NAME}_PACKAGE_REQUIRES "${CPACK_RPM_${IRODS_PACKAGE_COMPONENT_DEVELOPMENT_NAME}_PACKAGE_REQUIRES}, zeromq-devel")
endif()
if (IRODS_LINUX_DISTRIBUTION_NAME STREQUAL "opensuse")
