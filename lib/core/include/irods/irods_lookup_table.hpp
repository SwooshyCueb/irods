...
namespace irods
{
    ...
    class lookup_table
    {
      ...
      public:
        // clang-format off
        typedef typename irods_hash_map::key_type       key_type;
        typedef typename irods_hash_map::mapped_type    value_type;
        typedef typename irods_hash_map::size_type      size_type;
        typedef typename irods_hash_map::hasher         hasher;
