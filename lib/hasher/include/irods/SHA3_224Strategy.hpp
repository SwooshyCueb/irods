#ifndef IRODS_HASHER_SHA3_224_STRATEGY_HPP
#define IRODS_HASHER_SHA3_224_STRATEGY_HPP
...
namespace irods
{
    extern const std::string SHA3_224_NAME;

    class SHA3_224Strategy : public HashStrategy
    {
      public:
        SHA3_224Strategy() {};
        virtual ~SHA3_224Strategy() {};

        std::string name() const override
        {
            return SHA3_224_NAME;
        }
...
#endif // IRODS_HASHER_SHA3_224_STRATEGY_HPP
