...
def install_building_dependencies(externals_directory):
    externals_list = [
        ...
        'irods-externals-avro-libcxx1.11.0-4',
        'irods-externals-boost-libcxx1.81.0-2',
        'irods-externals-catch22.13.8-0',
        'irods-externals-clang-runtime16.0.6-0',
        'irods-externals-clang16.0.6-0',
        'irods-externals-cppzmq4.8.1-1',
        'irods-externals-fmt-libcxx8.1.1-2',
        'irods-externals-json3.10.4-0',
        'irods-externals-nanodbc-libcxx2.13.0-3',
        'irods-externals-spdlog-libcxx1.9.2-3',
        'irods-externals-zeromq4-1-libcxx4.1.8-2'
        ]
